...
if trainer_id == 0:
     file_name = 'Part1_scs.data'
else:
     file_name = 'Part2_scs.data'

train_reader = paddle.batch(
    paddle.reader.shuffle(
        scs_dataset.train(file_name), buf_size=500),
    batch_size=64)
test_reader = paddle.batch(scs_dataset.test(file_name), batch_size=64)
